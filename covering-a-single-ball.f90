...
subroutine drawsol(n,x)
  ...
  write(filename,"(A23,I0,A3)") 'covering-a-single-ball-',nballs,'.mp'
...
10 format('prologues := 3;',/, &
          ...
          'beginfig(',i3,');',/, &
          'u = 3.0 cm;')
20 format('fill fullcircle scaled 1.0u shifted (0u,0u) withcolor 0.9Dandelion;',/, &
