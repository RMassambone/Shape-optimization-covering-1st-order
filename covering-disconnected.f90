...
program algencanma
  ...
  logical :: coded(11),inS(4),inT(2),inTR(3)
  ...
  integer, parameter :: diffnballs(ndiff) = (/ 3, 7, 15 /)
...
10         continue
           ...
           inL = ( 0.0d0 .le. p(1) .and. p(1) .le. 1.0d0 .and. 0.0d0 .le. p(2) .and. p(2) .le. 3.0d0 ) .or. &
                 ( 1.0d0 .le. p(1) .and. p(1) .le. 3.0d0 .and. 0.0d0 .le. p(2) .and. p(2) .le. 1.0d0 )
           
           q(1:2) = p(1:2) - (/ 1.1d0, 1.1d0 /)
           inG = ( 0.0d0 .le. q(1) .and. q(1) .le. 1.0d0 .and. 0.0d0 .le. q(2) .and. q(2) .le. 3.0d0 ) .or. &
                 ( 1.0d0 .le. q(1) .and. q(1) .le. 2.0d0 .and. 1.0d0 .le. q(2) .and. q(2) .le. 2.0d0 )
           
           q(1:2) = p(1:2) - (/ 2.2d0, 3.2d0 /)
           inS(1) = 0.0d0 .le. q(1) .and. q(1) .le. 1.0d0 .and. 0.0d0 .le. q(2) .and. q(2) .le. 1.0d0
           q(1:2) = p(1:2) - (/ 2.2d0, 5.2d0 /)
           inS(2) = 0.0d0 .le. q(1) .and. q(1) .le. 1.0d0 .and. 0.0d0 .le. q(2) .and. q(2) .le. 1.0d0
           q(1:2) = p(1:2) - (/ 1.2d0, 4.2d0 /)
           inS(3) = 0.0d0 .le. q(1) .and. q(1) .le. 1.0d0 .and. 0.0d0 .le. q(2) .and. q(2) .le. 1.0d0
           q(1:2) = p(1:2) - (/ 3.2d0, 4.2d0 /)
           inS(4) = 0.0d0 .le. q(1) .and. q(1) .le. 1.0d0 .and. 0.0d0 .le. q(2) .and. q(2) .le. 1.0d0
           
           q(1:2) = p(1:2) - (/ 0.0d0, 3.1d0 /)
           inT(1) = q(2) .ge. 0.0d0 .and. &
                    q(2) .le.   sqrt( 3.0d0 ) * q(1) .and. &
                    q(2) .le. - sqrt( 3.0d0 ) * q(1) + sqrt( 3.0d0 )
           q(1:2) = p(1:2) - (/ 2.2d0, 1.1d0 /)
           inT(2) = q(2) .ge. 0.0d0 .and. &
                    q(2) .le.   sqrt( 3.0d0 ) * q(1) .and. &
                    q(2) .le. - sqrt( 3.0d0 ) * q(1) + sqrt( 3.0d0 )
           
           q(1:2) = p(1:2) - (/ 3.3d0, 5.3d0 /)
           inTR(1) = q(1) .ge. 0.0d0 .and. q(2) .ge. 0.0d0 .and.   q(1) + q(2) .le. 1.0d0
           q(1:2) = p(1:2) - (/ 1.1d0, 5.3d0 /)
           inTR(2) = q(1) .le. 1.0d0 .and. q(2) .ge. 0.0d0 .and. - q(1) + q(2) .le. 0.0d0
           q(1:2) = p(1:2) - (/ 3.3d0, 3.1d0 /)
           inTR(3) = q(1) .ge. 0.0d0 .and. q(2) .le. 1.0d0 .and.   q(1) - q(2) .le. 0.0d0
           
           inA = inL .or. inG .or. any( inS(1:4) ) .or. any( inT(1:2) ) .or. any( inTR(1:3) )
           if ( .not. inA ) then
              go to 10
           end if
           x(2*i-1) = p(1)
...
subroutine myevalc(n,x,ind,c,flag)
  ...
  ! LOCAL SCALARS
  logical :: inA,inL,inG,insomeball
  integer :: count,countinA,i,j,k,nx,ny
  real(kind=8) :: hx,hy

  ! LOCAL ARRAYS
  logical :: inS(4),inT(2),inTR(3)
  real(kind=8) :: p(2),q(2)
...
subroutine drawsol(n,x)
  ...
  write(filename,"(A22,I0,A3)") 'covering-disconnected-',nballs,'.mp'
...
10 format('prologues := 3;',/, &
          ...
          'beginfig(',i3,');',/, &
          'u = 1.0 cm;')
20 format('path L, G, S, T, TR[];',/, &
          'L = (0u,0u)--(0u,3u)--(1u,3u)--(1u,1u)--(3u,1u)--(3u,0u)--cycle;',/, &
          'G = (0u,0u)--(0u,3u)--(1u,3u)--(1u,2u)--(2u,2u)--(2u,1u)--(1u,1u)--(1u,0u)--cycle;',/, &
          'S = (0u,0u)--(0u,1u)--(1u,1u)--(1u,0u)--cycle;',/, &
          'T = (0u,0u)--(0.5u,0.5u*sqrt(3))--(1u,0u)--cycle;',/, &
          'TR[1] = (0u,0u)--(0u,1u)--(1u,0u)--cycle;',/, &
          'TR[2] = (0u,0u)--(1u,1u)--(1u,0u)--cycle;',/, &
          'TR[3] = (0u,0u)--(0u,1u)--(1u,1u)--cycle;',/, &
          'fill L withcolor 0.9Dandelion;',/, &
          'draw L withpen pencircle scaled 0.7;',/, &
          'fill G shifted (1.1u,1.1u) withcolor 0.9Dandelion;',/, &
          'draw G shifted (1.1u,1.1u) withpen pencircle scaled 0.7;',/, &
          'fill S shifted (2.2u,3.2u) withcolor 0.9Dandelion;',/, &
          'draw S shifted (2.2u,3.2u) withpen pencircle scaled 0.7;',/, &
          'fill S shifted (2.2u,5.2u) withcolor 0.9Dandelion;',/, &
          'draw S shifted (2.2u,5.2u) withpen pencircle scaled 0.7;',/, &
          'fill S shifted (1.2u,4.2u) withcolor 0.9Dandelion;',/, &
          'draw S shifted (1.2u,4.2u) withpen pencircle scaled 0.7;',/, &
          'fill S shifted (3.2u,4.2u) withcolor 0.9Dandelion;',/, &
          'draw S shifted (3.2u,4.2u) withpen pencircle scaled 0.7;',/, &
          'fill T shifted (0.0u,3.1u) withcolor 0.9Dandelion;',/, &
          'draw T shifted (0.0u,3.1u) withpen pencircle scaled 0.7;',/, &
          'fill T shifted (2.2u,1.1u) withcolor 0.9Dandelion;',/, &
          'draw T shifted (2.2u,1.1u) withpen pencircle scaled 0.7;',/, &
          'fill TR[1] shifted (3.3u,5.3u) withcolor 0.9Dandelion;',/, &
          'draw TR[1] shifted (3.3u,5.3u) withpen pencircle scaled 0.7;',/, &
          'fill TR[2] shifted (1.1u,5.3u) withcolor 0.9Dandelion;',/, &
          'draw TR[2] shifted (1.1u,5.3u) withpen pencircle scaled 0.7;',/, &
          'fill TR[3] shifted (3.3u,3.1u) withcolor 0.9Dandelion;',/, &
          'draw TR[3] shifted (3.3u,3.1u) withpen pencircle scaled 0.7;')
