...
program algencanma
  ...
  ! PARAMETERS
  integer, parameter :: ndiff = 1, ntrials = 1
  integer, parameter :: diffnballs(ndiff) = (/ 2 /)
...
10         continue
           ...
           inA = ( p(1) - 0.5d0 ) ** 2 + p(2) ** 2 .le. 0.25d0 .or. &
                 ( p(1) + 0.5d0 ) ** 2 + p(2) ** 2 .le. 0.25d0
...
subroutine drawsol(n,x)
  ...
  write(filename,"(A27,I0,A3)") 'covering-two-tangent-balls-',nballs,'.mp'
...
10 format('prologues := 3;',/, &
          ...
          'beginfig(',i3,');',/, &
          'u = 3.0 cm;')
20 format('fill fullcircle scaled 1.0u shifted (-0.5u,0u) withcolor 0.9Dandelion;',/, &
          'fill fullcircle scaled 1.0u shifted ( 0.5u,0u) withcolor 0.9Dandelion;',/, &
          'draw fullcircle scaled 1.0u shifted (-0.5u,0u) withpen pencircle scaled 0.7;',/, &
          'draw fullcircle scaled 1.0u shifted ( 0.5u,0u) withpen pencircle scaled 0.7;')
